...
```bash
helm install ui oci://nithin/nithin-shop-ui-chart:0.8.5
```

To install with custom values:

```bash
helm install ui oci://nithin/nithin-shop-ui-chart:0.8.5 --values custom-values.yaml
```
...
| image.repository                           | UI image repository                             | nithin/nithin-shop-ui                                                 |
